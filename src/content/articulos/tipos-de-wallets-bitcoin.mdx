...
- **Nunca una "wallet" que vive dentro de una plataforma de inversión** que te contactó por un anuncio: ahí no hay wallet ni claves, solo un panel con cifras escritas a mano. Es el núcleo del fraude de los [bots de inversión en Bitcoin](/articulos/bots-inversion-bitcoin-estafa/).
...
Sea cual sea el tipo de wallet, **lo que de verdad proteges es la frase semilla**. Una wallet hardware no sirve de nada si guardas la seed en una foto del móvil. La seguridad real está en cómo custodias esas 12 o 24 palabras. Lo desarrollamos en [Qué es una clave privada](/articulos/que-es-una-clave-privada/) y [Cómo proteger tus Bitcoin](/articulos/como-proteger-tus-bitcoin/). Y si alguien te pide esas palabras para "activar" o "verificar" una cuenta de inversión, estás ante el fraude que describimos en [bots de inversión en Bitcoin](/articulos/bots-inversion-bitcoin-estafa/).
