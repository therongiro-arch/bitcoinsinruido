...
description: "Un hash es una huella digital única de un dato. En Bitcoin, la función SHA-256 encadena bloques, asegura el Proof of Work y verifica transacciones. Explicado con ejemplos sencillos."
